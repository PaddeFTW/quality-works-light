  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-muted/10">
      ...
      <div className="min-h-0 flex-1 overflow-auto p-4 md:p-6">
        <div className="document-paper mx-auto min-h-[38rem] h-full w-full max-w-[820px] border border-border bg-white shadow-sm focus-within:ring-2 focus-within:ring-primary/30">
          <EditorContent
